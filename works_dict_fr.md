...
5. **Системный список работ** - универсальный справочник, содержащий все работы, когда-либо введенные пользователями системы в свои шахматки. На его основе пользователь выбирает работы для шахматки, пользуясь поиском.
...
7. Первый вход в раздел "Список работ":
    1. При создании нового пользователя для него создается сущность "пользовательский список работ" (строки в user_work_list), в него кладется "дефолтный список работ" ([сам список тут](/Дефолтные-работы.pdf)).
...
8. Пользователи могут добавлять новые строки в user_work_list
...
1. Пользователь может редактировать наименования работ (как внутри справочника работ шахматки так и внутри пользовательского списка работ)
2. Пользователь может удалять наименования работы из пользовательского списка работ.
...
5. Добавляется импорт и экспорт и файлов.
...
Для каждого из терминальных пунктов система производит поиск работ. Потом, если есть иерархическая структура, выстраивает ее.
