...
3. **Работа** - проведение конкретного наименования работ (work) в определенном помещении.  
4. "**Список работ**" - раздел web- и мобильного приложений, отвечающий за настройку переченя работ в шахматке.
5. **Дефолтный список работ** - неизменяемый стартовый шаблон ([данные тут](/Дефолтные-работы.pdf), [google-doc](https://docs.google.com/spreadsheets/d/1KBcwx9LyvH2fK0nzmJoen7atJCyp81WO-frnL3uYpXg/edit#gid=732289179)), из которого пользователь выбирает наименования работ для своей шахматки.
...
1. Таблицы work и work_group, содержащие информацию о **списке работ шахматки**, остаются без изменений.  
2. Создать новую таблицу (напр. work_list_templates или default_work_list) под **дефолтный список работ**. Также можно захардкодить, но есть подозрение, что потом шаблонов станет больше одного.  
...
2. Находясь в шахматке (в объекте): пользователь может перейти в раздел "**Список работ**":
    1. через выпадающее меню кнопки "Настройка":
        1. если в списке работ шахматки нет ни одной работы (на старте работы либо в случае полного удаления), система дублирет в рабочей области шахматки предложение настроить/создать список;
    ...
    2. через [контекстное меню левой панели](https://app.zeplin.io/project/63189e67cde56b49dacec5e2/screen/63d101a8ac1563680c3921f5) web-интерфейса по кнопке "Редактировать":
        1. В данном контекстном меню пользователь также может добавить новую работу напрямую, вызвав [модальное окно](https://app.zeplin.io/project/63189e67cde56b49dacec5e2/screen/63d101a1fd7ca66966563bc5), такое же, как при создании из раздела "Список работ".
