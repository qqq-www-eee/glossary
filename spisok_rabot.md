    ...
    4. выбирать одну или несколько наименований работ в списке работ шахматки (для удаления, для перемещения):
        1. Удаление:
            ...
            2. если к наименованию работ не привязаны работы (таски, задачи) ИЛИ при прямом согласии пользователя в модальном окне:
                ...
                3. Из дефолтного списка работ (таблицы work_list_templates) наименование работы никогда не удаляется.
                4. Для всех наименований работ из списка дефолтных:
                    1. Они удаляются из UI и из БД (таблица work);
                ...
                5. Для всех наименований работ, введенных пользователем:
                    1. Они удаляются из UI и из БД (таблица work);
