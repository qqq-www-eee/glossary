...
3. Находясь в разделе "Список работ":
...
6. Пользователь-"Владелец" и пользователь-"Редактор" могут:
    ...
    4. выбирать одну или несколько наименований работ в списке работ шахматки (для удаления, для перемещения):
        1. Удаление: если к наименованию работ в шахматке привязаны работы (таски, задачи):
            1. показать модальное окно "Внимание! Все равно удалить?". При согласии:
