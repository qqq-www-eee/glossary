...
6. Пользователь с правами "Чтение" может просматривать список работ, но не может ничего в нем редактировать; может клонировать список работ к себе в шахматки. Пользователь с правами "Редактирование" может все то же, что владелец, в т. ч. числе редактировать список работ и клонировать его к себе в шахматки.
