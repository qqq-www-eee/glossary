...
1. При настройке списка работ для шахматки работа ведется в двух областях интерфейса. Левая всегда отвечает за один и тот же системный шаблон на основе [этих данных](https://docs.google.com/spreadsheets/d/1KBcwx9LyvH2fK0nzmJoen7atJCyp81WO-frnL3uYpXg/edit#gid=732289179). Шаблон неизменяемый, не имеет иерархической структуры (плоский). Правая отвечает за настройку текущей пользовательской шахматки.
2. В левой части экрана пользователь может:
    1. добавить одну/несколько работ из шаблона в шахматку. При этом наименования работ перестанут отображаться в левой части ui и начнут отображаться в корне структуры в правой части ui.
3. В правой части экрана пользователь может:
    1. содать новые наименования работ, новые Виды работ (пустые папки);
    ...
    3. удалять выбранные наименования работ, выбранные виды работ (папки).
