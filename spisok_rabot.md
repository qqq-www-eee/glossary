...
2. В левой части экрана пользователь может:
    1. добавить одну/несколько выбранных работ из шаблона в шахматку. При этом наименования работ перестанут отображаться в левой части ui и начнут отображаться в корне структуры в правой части ui.
3. В правой части экрана пользователь может:
    ...
    5. работать сразу с готовым списком работ:
