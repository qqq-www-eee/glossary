...
3. Формирование нового реестра.
    ...
    2. **Шаг 2 формирования нового реестра: "Расценки"**.
        1. Система предоставляет пользователю возможность указать расценку для каждой из названий работ, выбранных пользователем на Шаге 1.
            ...
            2. Все работы, выбранных пользователем на Шаге 1:
        ...
        6. Если хотя бы для одной работы поле "Цена" не заполнено, система отрисовывает ошибку для этих инпутов и не позволяет перейти далее
        7. **Нужно единообразие ошибки на шаге 1 (сейчас желтое уведомление) и шаге 2 (сейчас красный инпут). Тот же вопрос "Красный инпут vs уведомление" существует и при вводе телефона и кодов при регистрации, нужно одно решение на всех**).
