...
5. Отображение записей об оплате в боковой панели.
    1. В интерфейсе шахматки:
        1. если в левой панели выбрана некоторая работа и в рабочей области выбрана некоторая ячейка, в боковой панели система отображает данные по всем записям об оплате (payment_report_task, у которых связанный реестр имеет статус "Оплачено") для данной комбинации **название_работы** + **этаж** + **room_group**. Отображаемые данные:
...
6. Другие требования.
    1. Добавить новый тип логов в историю изменений работы: "Задача внесена в реестр №ХХ".
