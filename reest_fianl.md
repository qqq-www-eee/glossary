...
При создании самого первого реестра цены должны быть предзаполнены для тех работ, которые были взяты из шаблона, и в шаблоне была указана ненулевая расценка (не 0 и не null).
У тех работ, что созданы руками, цена не предзаполнена.
У тех работ, что взяты из шаблона, но цена в шаблоне была 0 или  null, цена не предзаполнена.


По-хорошему сразу при создании работ надо указывать расценку, но мы редактируем через наряды. Так можно и цену скорректировать, и название работы не трогать.
