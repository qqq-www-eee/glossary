...
9. Доступы не разделяются. Доступ на редактирование шахматки = доступ на создание/редактирование замечаний = доступ на создание реестров.
10. В реестрах необходимо добавить новый столбец "Накопительный итог":
...
1. Общие требования:
    ...
    2. Для **боковой панели** и для **карточки работы**:
    ...
    6. Кнопка для перехода в раздел "Закрытие реестров" скрыта, пока в шахматке не настроены все справочники:
        1. сам объект;
