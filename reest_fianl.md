...
3. Формирование нового реестра.
    ...
    2. **Шаг 2 формирования нового реестра: "Расценки"**.
        ...
        2. Если расценка на работу с данным именем на данном объекте:
        ...
        3. Порядок отображения полей "Цена" - алфавитный.
        4. Система позволяет пользователю вернуться на экран выбора работ для реестра без сохранения значений полей "Цена", даже если они были заполнены пользователем.
        5. Если хотя бы для одной работы поле "Цена" не заполнено, система отрисовывает ошибку для этих инпутов и не позволяет перейти далее
        6. **Нужно единообразие ошибки на шаге 1 (сейчас желтое уведомление) и шаге 2 (сейчас красный инпут). Тот же вопрос "Красный инпут vs уведомление" существует и при вводе телефона и кодов при регистрации, нужно одно решение на всех**).
