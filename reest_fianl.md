...
3. Формирование нового реестра.
    1. **Шаг 1 формирования нового реестра: "Работы"**.
        1. В исходный список попадают работы, у которых: 
            ...
            4. ~~Незакрытые замечания невозможно привязать к конкретной работе, только к помещению;~~
        ...
        5. Система должна подсвечивать пользователю работы, которые проводятся в помещениях, в которых есть незакрытые замечания;
        6. Система предоставляет возможность перейти из списка работ в карточку конкретной работы.
        ...
        9. Система должна отображать количество выбранных пользователем работ:
