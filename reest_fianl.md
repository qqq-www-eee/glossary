...
1. Общие требования:
    ...
    3. Пользователи с правом на "Чтение", на "Редактирование" и "Владелец" одинаково взаимодействуют с контролами в **панели действий**, и с сслыками в **боковой панели** и **карточке работы** - все попадают на одни и те же страницы с реестрами, могут просматривать реестры, нажимать на контролы "Создать реестр на выплату" вверху экрана или в заглушке.
        4. "Чтец":
