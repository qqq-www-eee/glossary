...
3. Формирование нового реестра.
    1. **Шаг 1 формирования нового реестра: "Работы"**.
        1. В исходный список попадают работы, у которых: 
            1. Указаны "Исполнители";
            2. Указаны "Объемы" (Выполненных работ).
            3. ~~Не хотим заставлять пользователя переводить 30 работ в "Завершено", чтобы потом восстанавливать им правильные статусы, если работа завершена частично;~~
            4. ~~Незакрытые замечания невозможно привязать к конкретной работе, только к помещению, но видеть их при закрытии наряда по идее полезно;~~
        2. Система предоставляет пользователю возможность выбрать работы, которые войдут в реестр; 
        3. Система предоставляет возможность отфильтровать работы:
            1. по названию; 
            2. по месту проведения работ (этаж + room_group);
            3. по исполнителю;
            4. по статусу ("Завершено", "Ожидает дефектовку" и др.).
        4. Система предоставляет возможность сортировать работы по столбцам таблицы:
            ...
            6. по сумме к выплате:
                1. как определяется стоимость почасовых работ: система умножает стоимость часа на количество часов.
            7. по статусу работы (порядок сортироваки согласно бизнес-логике: 'volumeEdit' - 'draft' - 'inProgress' - 'readyToCheckTechnicalSupervisor' - 'hasRevisions' - 'completed' и обратный).
        ...
        6. Система должна подсвечивать пользователю работы, которые проводятся в помещениях, в которых есть незакрытые замечания.
        7. Система предоставляет возможность по клику на отметку о наличии незакрытых замечаний в помещении увидеть список этих замечаний (в сайд-панели?) и перейти в них.
        8. Система должна отображать количество выбранных пользователем работ:
            1. если пользователь выбрал А работ, а результаты фильтрации/поиска показывают B работ, отображать все еще число A.
        9. Система предоставляет возможность сбросить каждый из фильтров к исходному состоянию.
        10. Система предоставляет возможность выбрать все отфильтрованные работы с сохранением выбранных ранее позиций.
        11. Система предоставляет возможность снять выделение со всех отфильтрованных работ с вычитанием этих позиций из числа ранее выбранных.
