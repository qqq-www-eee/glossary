...
6. Другие требования.
    1. Добавить новый тип логов в историю изменений работы: "Задача внесена в реестр №ХХ от XX.XX.XXXX".
    4. Редакторы и владельцы могут вручную менять статус "Оплачен" и "Сформирован" туда и обратно без ограничений.
    3. В карточку работы должно быть можно перейти из боковой панели в профиле работы (не только из профиля "Вид работ").
