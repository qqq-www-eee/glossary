...
2. Просмотр списка реестров.
    1. Если для данной шахматки создан хотя бы один реестр, система предоставляет пользователю возможность просмотреть все реестры шахматки (статусы "Оплачен" и "Сформирован", других нет) в табличном виде, в столбцах которой:
    ...
    2. Дефолтная сотрировка списка реестров - по дате создания, сверху новые.
    3. Система предоставляет пользователю возможность осуществить сортировку таблицы реестров:
