...
1. Реестры могут находиться в статусах "Сформирован", "Удален", "Оплачен":
    ...
    2. "**Оплачен**" - будет автоматически проставляться после интеграции с 1С, сейчас проставляется руками через контрол (в заглушке после кнопки "Отправить в 1С"? вместо кнопкуи "Отправить в 1С"?); данный статус означает: система учитывает этот реестр при подсчете лимитов;
...
2. У реестров есть два важных кейса применения:
