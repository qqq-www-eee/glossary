...
## Требования к РАБОТА (ЧАСТИЧНАЯ РАБОТА, отображение внутри наряда)
...
> В дальнейшем обсуждении будут задействованы 5 таблиц, 3 из которых уже существуют, 2 предлагается добавить, они имеют очень простую структуру.  

Существуют: **payment_report** и **task** и связывающая их **payment_report_task**.  
...
> Если что, всегда можно создать наряд с начала времен по сей день - он соберет в себя все случайно потерявшиеся таски.
...
### PAYMENT_REPORT - наряд (таблица уже существует)

Хотим внести дополнения.
...
Тоже никаких изменений не требуется.
