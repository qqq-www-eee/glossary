...
-
  ...
  7. Система предлагает на выбор два вопроса, ответом на один из которых будет контрольное слово, напр. "Девичья фамилия матери", "Кличка первого животного" или другое.
...
14. Служебное поле "Логин" обязано быть уникальным.

15. Если пользователь для входа в систему использует номер, представленный в системе как "Логин", происходит авторизация, иначе происходит регистрация.

16. "Номер телефона" может отличаться от "Логина", только если пользователь сменил его в своих настройках.

17. **Пользователей нельзя добавлять в списки шахматок.**

18. Система предоставляет каждому **пользователю** возможность управлять своим "Списком контактов" (по аналогии с "телефонной книгой") - создавать, редактировать, просмативать и удалять **контакты**.

19. Система предоставляет **пользователю** возможность добавлять **свои контакты** в списки "Исполнители" в шахматках.

20. Система предоставляет **пользователю** возможность добавлять **свои контакты** в списки "Технадзор" в шахматках.
