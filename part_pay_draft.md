...
1. **Наряд** - таблица, отражающая объёмы выполненных работ за определенный период (часто за неделю) по всем работникам секции; закрывются технадзорами.
2. **Реестр на выплату** - документ, формируемый после закрытии наряда руководителем координации; это финансовая выжимка наряда с указанием сумм к выплате; отправляется в бухгалтерию. 
3. **Расчетный период** - период времени, за который составляется наряд (и реестр на выплату).
4. **Работа** - проведение определенного наименования работ в определенном помещении в течение одного или нескольких расчетных периодов. Работа разбивается на "частичные работ" (это уже "таски", или "задачи"), у которых по бизнесу исполнитель подразумевается неизменным за время ее жизни.  
5. **Частичное закрытие наряда** (иногда **процентовка**) - процесс сбора и подготовки информации по объекту для оплаты за один расчетный период (то же6 что и "закрытие таски", "закрытие частиной работы", "закрытие задачи").
