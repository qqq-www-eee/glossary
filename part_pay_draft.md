...
1. Быстродействие - уточнить.
2. Безопасность:
    1. Доступ к просмотру и редактированию реестров, по-хорошему, необходимо настраивать отдельно от просмотра/редактирования шахматки, иначе либо редакторов будет мало, либо знать они будут слишком много.
