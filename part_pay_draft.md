...
5. Отображение **записей об оплате** в **боковой панели**.
    1. В интерфейсе шахматки, если в левой панели выбрана некоторая работа, в рабочей области выбрана некоторая ячейка/ячейки, то в боковой панели обображаются данных из всех **записей об оплате** для данной работы:
        1. asdf
        2. Это текст. Он ни в коем случае не показывает ничего про деньги, но показывает кое-что про объемы.
        3. asdf
