...
2. Просмотр списка реестров.
    1. В разделе "Реестры" система должна предоставлять пользователю возможность просмотреть наряды в статусах "Удален", "Оплачен" и "Сформирован". 
    2. Пользователь может скрыть реестры в статусе "Удален".
    3. Система должна предоставлять пользователю возможность создать новый реестр на выплату.
    4. Система должна предоставлять пользователю возможность вернуться назад к шахматке.
    5. Если для данной шахматки еще не было создано ни одного реестра, в разделе "Реестры" должна показываться заглушка с дублирующим контролом для создания нового реестра.
    6. Если для данной шахматки создан хотя бы один реестр, система отображает таблицу, в строках которой отображены существующие реестры, а в столбцах:
        1. Порядковый номер реестра;
        2. Дата создания реестра;
        3. Статус реестра. 
    7. В разделе "Реестры" система должна предоставить пользователю возможность осуществить сортировку таблицы с реестрами:
        ...
        3. Статус реестра - прямая и обратная последовательность статусов: "Оплачен" - "Сформирован" - "Удален". 
    8. ~~Фильтрация в списке нарядов отсутствует.~~
    9. ~~Быстрый поиск в списке нарядов отсутствует.~~
3. Формирование нового реестра.
    1. Шаг 1 формирования нового реестра.
        1. Система должна предоставлять пользователю возможность выбрать одну или несколько работ шахматки, которые войдут в наряд;
        2. Система предоставляет возможность фильтровать работы:
            1. по названию работы; 
            2. по месту проведения работ (этаж + room_group);
            3. по исполнителю;
            4. ~~по статусу работы.~~
        3. Система предоставляет возможность сортировать работы (столбы таблицы) по:
            1. по названию работы;
            ...
            8. ~~накопительный итог~~
            4. ~~по статусу работы.~~ 
        4. Система должна отображать количество выбранных пользователем работ:
            1. если пользователь выбрал А работ, а результаты фильтрации/поиска вернули B работ, отображать число A.
        5. Система предоставляет возможность сбросить каждый из фильтров к исходному состоянию.
        
        3. Фильтрация и сортировка
    2. Шаг 1 формирования нового реестра.
        1. фыва
        2. фвыа
        3. Фильтрация и сортировка
