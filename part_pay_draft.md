...
2. Просмотр списка реестров.
    ...
    3. По умолчанию рыть реестры в статусе "Удален".
    4. Система должна предоставлять пользователю возможность создать новый реестр на выплату.
    5. Система должна предоставлять пользователю возможность вернуться назад к шахматке.
    6. Если для данной шахматки еще не было создано ни одного реестра, в разделе "Реестры" должна показываться заглушка с дублирующим контролом для создания нового реестра.
    7. Если для данной шахматки создан хотя бы один реестр, система отображает таблицу, в строках которой отображены существующие реестры, а в столбцах:
        1. Порядковый номер реестра;
        2. Дата создания реестра;
        3. Статус реестра. 
    8. В разделе "Реестры" система должна предоставить пользователю возможность осуществить сортировку таблицы с реестрами:
    ...
    9. ~~Фильтрация в списке нарядов отсутствует.~~
    10. ~~Быстрый поиск в списке нарядов отсутствует.~~
