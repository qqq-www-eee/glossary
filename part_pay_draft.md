...
1. Дефектовка происходит только один раз в начале работы, а Замечания ТН оставляют каждый расчетный период (~один раз в частичную работу).
...
Это позволит нам удобно объединять две, три, десять тасок, проводимых в одном и том же помещении. Ну или даже скорее просто удобно нам.
