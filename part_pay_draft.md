...
3. Формирование нового реестра.
    1. Шаг 1 формирования нового реестра.
        ...
        6. Система предоставляет возможность выбрать все отфильтрованные работы с сохранением выбранных ранее позиций.
        7. Система предоставляет возможность снять выделение с отфильтрованных работ с вычитанием этих позиций из перечня ранее выбранных позиций.
    2. Шаг 2 формирования нового реестра.
        1. Система предоставляет пользователю возможность указать расценку для каждой из работ, выбранных для наряда.
            1. Расценка на работу зависит от названия работы и от объекта;
            2. Расценка на работу для разных мастеров на одном и том же объекте, делающих одну и ту же работу, одинакова.
        ...
        3. Если расценка на работу с данным именем и на данном объекте:
            ...
            2. ранее не указывалась пользователем в этой шахматке, оставить непредзаполненным.
        2. фвыа
