...
Мы не принуждаем пользователя отчитываться строго по неделям - ему могут быть удобны расчеты раз в 2 недели, раз в месяц и пр. (кратные неделе периоды). Однако даже если итерироваться по неделям, мы не знаем, по понедельникам у пользователя отчетность или по пятницам. Это подталкивает к тому, чтобы рано или поздно **пользователь сможет выставлять отчетный период произвольно**.  

Это может вести к колизиям. Пример: коллега закрывает пн-ср, потом пользователь закрывает пн-пт и отправляет на оплату; затем коллега также отправляет свой наряд на оплату. В подобных случаях информация в проводках бухгалтерии имеет шанс задублироваться, да и в целом такое поведение может разочаровать пользователя. Поэтому дополнительные проверки в системе предлагается все-таки производить.
