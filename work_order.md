...
Обычно:  
1. **Заказ-наряд (наряд)** - формируемый перед началом работ документ, содержащий название-описание предстоящих работ для конкретного работника (обычно на ближайшую неделю), в которой ставится его подпись и подпись выдавшего работу начальника (прораба, мастера участка). В конце, после выполнения работ, подпись также ставит приемщик работ (технадзор) и в конце кто-то из бухгалтерии. Наряд - срез в момент времени вдоль работ.  
Обычно в ПИК эта формальная процедура опускается и наряды раздаются людям в устрой форме в штабе.  
2. **Табель** - таблица учета почасовых (поденных, повременных и пр.) работ, вид работа один и тот же. Табель - срез конкретной работы вдоль времени. Табель - это закрытый график по часам за период.  
3. На основании **наряда** или **табеля** в 1С создаются **начисления** и **ведомости на счета** (ведомость на выплату заработной платы на счета сотрудников).

У нас:  
**Наряд** (он же отчет) - это объёмы любых выполненных работ (как сдельных, так и почасовых) за определенный период (за последнюю неделю) одновременно по всем работникам в подчинении определенного прораба.
**Реестр на выплату** - закрытый наряд с указанными суммами к выплате.
