...
> Из пользователей надо убрать Имя и Должность при выдаче доступа - просто телефон указываем пока что! Это поинт в пользу того, что вообще не нужны нам алиасы. Но и при этом без справочников хз как обойтись - а то у нас заменятся имена.
> ReadytoPay нужно убрать из рабочих статусов и сделать статусы об оплате: "Ничего", "Готов к оплате", "Оплачен".

!!!



### Требования к РАБОТА (в рамках наряда)

Наряд - это список работ, которые:
- находятся в рабочем статусе «Завершено»,
- у них указаны исполнители,
- у них указаны выполненные объёмы,
- не попали в сформированные ранее ~~табели~~ наряды.

Предлагается вести системе ДВА статуса!
Один относится к **работе**,  
другой - к сущности **оплаченный работы кусок**:  
