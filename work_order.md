...
> - добавить в список работ следующие, подозрительные почасовые работы:
...
>   - 9 - Реставрация - доработка/исправление работ после смежников, доделки мелкие - но это, видимо, обобщающее название, пришло отдельно.
