...
**Табель 1С** — это документ в 1С, содержащий закрытый график по часам за определенный период.  
**Наряд 1С** — это документ, содержащий объемы выполненных работ. Рабочие на стройке получают выплаты согласно **нарядам 1C**.  
