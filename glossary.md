...
**Наряд** (~~неправильно: табель~~) — в **продукте** это таблица, содержащая объемы работ для выполнения или объемы уже произведенных работ за период (часто период = ( 1 день | 1 неделя )). 
