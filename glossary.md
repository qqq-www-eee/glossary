...
- **Панель представления** - панель в верхней части интерфейса, содержащая несколько вкладок, отвечающих за выбор представления шахматки (в Excel такие "представления" называются листами). Настраивается пользователем.
