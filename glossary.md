...
На основании одного из этих документов создается начисление и ведомости на счета:  
...
- **Наряд** (~~неправильно: табель, реестр выплат, табель выплат~~) — в **продукте** это таблица, содержащая объемы работ для выполнения или объемы уже произведенных работ за определенный период. Часто период = ( 1 день ^ 1 неделя ).  

- **Вид работ** (~~неправильно: группа работ~~) — совокупность нескольих элементарных работ, сгруппированный логически или как захотелось пользователю. Пример:
