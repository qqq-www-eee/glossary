...
**Секция** (~~неправильно: проект, корпус, объект~~) — сущность системы, соответствующая одному физическому объекту на стройке, закрепленому за одним человеком и содержащем однообразные объекты. На практике это подъезд, в котором ведутся работы, курируемые **пользователем** (прорабом).

**Этаж** — этаж.

**Помещение** (~~неправильно: ячейка, квартира~~) — квартира в новостройке либо иное помещение (например, в коммерческой недвижимости), имеющее выход в общее пространство этажа и обладающее одинаковыми со смежными помещениями свойствами при навигации по этажам.
<br>
<br>
<br>
